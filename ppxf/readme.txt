...
capfit.py                   ---> Levenberg-Marquardt with box constraints and fixed/tied variables
...
The procedure PPXF uses the CAPFIT Python procedure, which is already 
...
The program was tested on:
    ...
    Python 3.6 using NumPy 1.13, SciPy 0.19, Matplotlib 2.0 (and legacy Python 2.7)
...
Last updated: MC, Oxford, 4 July 2017
